...
- Ye, Z., Ai, Q., Liu, Y., de Rijke, M., Zhang, M., Lioma, C., & Ruotsalo, T. (2024). Generative language reconstruction from brain recordings. *Research Square*. [`DOI`](https://doi.org/10.21203/rs.3.rs-4587150/v1)
...
- Tikochinski, R., Goldstein, A., Meiri, Y., Hasson, U., & Reichart, R. (2024). Incremental accumulation of linguistic context in artificial and biological neural networks. *bioRxiv*. [`DOI`](https://doi.org/10.1101/2024.01.15.575798)
