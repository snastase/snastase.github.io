...
Hong, Z.\*, Wang, K.\*, Zada, Z., Gazula, H., Turner, D., Aubrey, B., Niekerken, L., Doyle, W., Devore, S., Dugan, P., Friedman, D., Devinsky, O., Flinker, A., Hasson, U.\*, Goldstein, A.\*, & **Nastase, S. A.**\* (in press). Scale matters: large language models with billions (rather than millions) of parameters better match neural representations of natural language. *eLife*. [`DOI`](https://doi.org/10.1101/2024.06.12.598513) [`PDF`](https://snastase.github.io/files/Hong_bioRxiv_2024.pdf)
