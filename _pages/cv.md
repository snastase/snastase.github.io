...
Hong, Z.\*, Wang, K.\*, Zada, Z., Gazula, H., Turner, D., Aubrey, B., Niekerken, L., Doyle, W., Devore, S., Dugan, P., Friedman, D., Devinsky, O., Flinker, A., Hasson, U.\*, Goldstein, A.\*, & **Nastase, S. A.**\* (2024). Scale matters: large language models with billions (rather than millions) of parameters better match neural representations of natural language. *bioRxiv*. [`DOI`](https://doi.org/10.1101/2024.06.12.598513) [`PDF`](https://snastase.github.io/files/Hong_bioRxiv_2024.pdf)

Chang, C. H., **Nastase, S. A.**, & Hasson, U. (in press). How a speaker herds the audience: multi-brain neural convergence over time during naturalistic storytelling. *Social Cognitive and Affective Neuroscience*. [`DOI`](https://doi.org/10.1101/2023.10.10.561803) [`PDF`](https://snastase.github.io/files/Chang_bioRxiv_2023.pdf)
