...
**Nastase, S. A.** (2025). Larger language models better align with the reading brain. *Nature Computational Science*, *5*, 994–995. [`DOI`](https://doi.org/10.1038/s43588-025-00905-7) [`PDF`](https://snastase.github.io/files/Nastase_NCS_2025.pdf)
...
Xu, Q., Peng, Y., **Nastase, S. A.**, Chodorow, M., Wu, M., & Li, P. (2025). Large language models without grounding recover non-sensorimotor but not sensorimotor features of human concepts. *Nature Human Behaviour*, *9*, 1871–1886. [`DOI`](https://doi.org/10.1038/s41562-025-02203-8) [`PDF`](https://snastase.github.io/files/Xu_NatHumBehav_2025.pdf)
...
Hong, Z.\*, Wang, K.\*, Zada, Z., Gazula, H., Turner, D., Aubrey, B., Niekerken, L., Doyle, W., Devore, S., Dugan, P., Friedman, D., Devinsky, O., Flinker, A., Hasson, U.\*, Goldstein, A.\*, & **Nastase, S. A.**\* (2024). Larger language models better align with neural representations of natural language. *eLife*, *13*, RP101204. [`DOI`](https://doi.org/10.7554/eLife.101204.3) [`PDF`](https://snastase.github.io/files/Hong_eLife_2024.pdf)
